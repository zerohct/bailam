...
namespace DOAN_QLBH.BLL
{
    class BLL_nhacungcap
    {
        ...
        public void themncc()
        {
            int ketqua = dal_nhacungcap.themncc(frm_nhacungcap.txt_mancc.Text, frm_nhacungcap.txt_tenncc.Text, frm_nhacungcap.txt_diachi.Text, frm_nhacungcap.txt_sdt.Text, frm_nhacungcap.txt_email.Text);
        ...
        public void suancc()
        {
            int ketqua = dal_nhacungcap.suancc(frm_nhacungcap.txt_mancc.Text, frm_nhacungcap.txt_tenncc.Text, frm_nhacungcap.txt_diachi.Text, frm_nhacungcap.txt_sdt.Text, frm_nhacungcap.txt_email.Text);
